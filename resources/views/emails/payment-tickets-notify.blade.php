...
<br> <br>
<p style="padding: 0px;">
    Se le notifica que se ha vendido un nuevo boleto de la rifa <span style="font-weight: bold;">"{{ $data['raffle']->name }}"</span>
    <br>
    A continuación, encontrará los detalles de los boletos vendidos:
    <br> <br>
</p>
<table>
        <tr>
        ...
        <tr>
            ...
            <td style="color: {{ empty($data['seller']) ? '#D62829' : '#003049' }}; font-weight: bold; font-style: italic;">
               {{ empty($data['seller']) ? 'Pendiente' : 'Pagado por tarjeta de crédito, débito o venta física.'  }} 
            </td>
        </tr>
</table>
